  ...
  return (
    <div>
      <div className="bg-white p-6 rounded-xl border-2 border-blue-200 mb-8">
        ...
        <div className="mb-6">
          <div className="inline-flex items-center px-4 py-2 rounded-full bg-gradient-to-r from-orange-100 to-orange-50 border border-orange-200">
            ...
            <span className="text-orange-800 font-semibold">{companyInfo.field}</span>
          </div>
          <div className="mt-2 text-orange-700 text-sm">
            {companyInfo.subfield}
          </div>
        </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                <div className="mb-4">
                  ...
                  <div className="text-blue-800 font-medium">{companyInfo.operationType}</div>
                </div>
      ...
      <div className="bg-white p-6 rounded-xl border-2 border-blue-200">
        ...
        {companyInfo.introduction && companyInfo.introduction.map((paragraph, index) => (
